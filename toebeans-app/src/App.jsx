...
// --- JSDoc Type Definitions (for documentation/linting clarity) ---
 ...
 * @property {string} doseAmount - Required dose amount (e.g., 25)
 * @property {string} doseUnit - Required dose unit (e.g., mg)
 ...
 * @returns {number}
 */
const convertToBaseUnit = (value, fromUnit, type) => {
 ...
 */
const calculateDosage = (medication) => {
